      ...
      <div className="space-y-5">
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-2xl bg-[#12121a] border border-[#1e1e2d] shadow-sm space-y-2">
            ...
            <p className="text-xs md:text-sm text-slate-400 leading-relaxed">A: Yes! You can edit text directly in the Copywriter tab, or use the "Request Changes" button to let the AI rewrite it with your feedback notes.</p>
          </div>
