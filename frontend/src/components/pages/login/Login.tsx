  ...
  return (
    <>
      ...
      <div className={`min-h-screen h-screen flex flex-col md:flex-row bg-[#0A0A0F] antialiased overflow-hidden transition-opacity duration-500 ${flipped ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <div className={`hidden md:flex md:w-1/2 border-r border-[#1C1C26] overflow-y-auto ${mounted ? 'animate-slide-left' : 'opacity-0'}`}>
        ...
        {/* RIGHT — Form panel */}
        <div className={`w-full md:w-1/2 bg-[#0A0A0F] overflow-y-auto ${mounted ? 'animate-slide-right' : 'opacity-0'}`}>
