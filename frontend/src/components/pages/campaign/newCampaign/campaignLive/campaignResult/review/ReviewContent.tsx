  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        <div className="card-elevate col-span-1 md:col-span-4 bg-[#111118] border border-[#2A2A38] rounded-xl p-6 flex flex-col justify-center items-center relative overflow-hidden group hover:border-[#2A2A38]/80 transition-colors">
        ...
        <div className="card-elevate col-span-1 md:col-span-8 bg-[#111118] border border-[#2A2A38] rounded-xl p-5 md:p-6 relative">
